<script>
  ...
  async function postData() {
    // const response = await fetch('https://historeno.heig-vd.ch/tool/index.php?mode=ptf', {
    //   method: 'POST',
...
<div class="cm_expert_button">
  <button class="btn btn-success" type=submit  onclick="{postData}">MODE AVANCÉ </button>
</div>
